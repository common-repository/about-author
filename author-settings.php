...
if(isset($_POST['submit']) && isset($_POST['security'])) {
	...
	$auther_lbl_text        = sanitize_text_field($_POST['auther_lbl_text']);
	...
	<form method="post" action="">
		...
		<table class="form-table" style="margin-left:20px; width: 98%;"  >
			...
			<tr>
				...
				<td>
					<input type="radio" name="switch_off_page" id="switch_off_page" value="<?php echo esc_attr('yes');?>" <?php checked( 'yes', $switch_off_page ); ?> ><?php esc_html_e('Yes', 'WEBLIZAR_ABOUT_DOMAIN' ); ?>
					<input type="radio" name="switch_off_page" id="switch_off_page" value="<?php echo esc_attr('no');?>" <?php checked( 'no', $switch_off_page ); ?>><?php esc_html_e('No', 'WEBLIZAR_ABOUT_DOMAIN' ); ?>
				</td>
			</tr>
				<?php if(!isset($switch_off_post)) { $switch_off_post = "no"; }?>
				<th><?php esc_html_e('On post', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></th>
				<td><input type="radio" name="switch_off_post" id="switch_off_post" value="<?php echo esc_attr('yes');?>" <?php checked( 'yes', $switch_off_post ); ?> ><?php esc_html_e('Yes', 'WEBLIZAR_ABOUT_DOMAIN' ); ?>
					<input type="radio" name="switch_off_post" id="switch_off_post" value="<?php echo esc_attr('no');?>" <?php checked( 'no', $switch_off_post ); ?>><?php esc_html_e('No', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></td>
				</tr>
				<tr>
			...
			<tr>
				...
				<td>
					<select id="Author_short_code" name="Author_short_code">
						<option value="<?php echo esc_attr('1');?>"> <?php esc_html_e( 'Select Any Shortcode', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
						<?php
			...
			<tr>
				...
				<td><input type="radio" name="switch_off_name" id="switch_off_name" value="<?php echo esc_attr('yes');?>" <?php checked( 'yes', $switch_off_name ); ?> ><?php esc_html_e('Yes', 'WEBLIZAR_ABOUT_DOMAIN' ); ?>
				<input type="radio" name="switch_off_name" id="switch_off_name" value="<?php echo esc_attr('no');?>" <?php checked( 'no', $switch_off_name ); ?>><?php esc_html_e('No', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></td>
			</tr>
			<tr>
				<th><?php esc_html_e('Website Name', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></th>
				<td>
					<?php if(!isset($switch_off_web)) { $switch_off_web = "no"; }?>
					<input type="radio" name="switch_off_web" id="switch_off_web" value="<?php echo esc_attr('yes');?>" <?php checked( 'yes', $switch_off_web ); ?> ><?php esc_html_e('Yes', 'WEBLIZAR_ABOUT_DOMAIN' ); ?>
					<input type="radio" name="switch_off_web" id="switch_off_web" value="<?php echo esc_attr('no');?>" <?php checked( 'no', $switch_off_web ); ?> > <?php esc_html_e('No', 'WEBLIZAR_ABOUT_DOMAIN' ); ?>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<input type="radio" name="switch_off_bio_info" id="switch_off_bio_info" value="<?php echo esc_attr('yes');?>" <?php checked( 'yes', $switch_off_bio_info ); ?>><?php esc_html_e('Yes', 'WEBLIZAR_ABOUT_DOMAIN' ); ?>
					<input type="radio" name="switch_off_bio_info" id="switch_off_bio_info" value="<?php echo esc_attr('no');?>" <?php checked( 'no', $switch_off_bio_info ); ?>><?php esc_html_e('No', 'WEBLIZAR_ABOUT_DOMAIN' ); ?>
				</td>
			</tr>
			<tr>
				...
				<tr>
					...
					<td>
						<p><input  type="text" class="my-color-picker" id="Author_bg_color" name="Author_bg_color" 
						value="<?php if(!isset($Author_bg_color)) {	echo esc_attr($Author_bg_color = "#dd3333"); 	} else { echo esc_attr($Author_bg_color); }?>"/><p>
					</td>
				</tr>
				<tr>
					...
					<td><p><input class="my-color-picker" id="Author_Color" name="Author_Color" type="text" 
					 ...
					 { echo esc_attr($Author_Color = "#ffffff"); } else { echo esc_attr($Author_Color); } ?>"></p></td>
				</tr>
				<tr>
					...
					<td><?php if(!isset($Author_PGPP_Font_Style)) { $Author_PGPP_Font_Style = "Courier New"; }?>
						<select  name="Author_PGPP_Font_Style" id="Author_PGPP_Font_Style" class="standard-dropdown" >
							<optgroup label="Default Fonts">
								<option value="<?php echo esc_attr('Arial');?>" <?php selected($Author_PGPP_Font_Style, 'Arial' ); ?>><?php esc_html_e( 'Arial', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Arial Black');?>" <?php selected($Author_PGPP_Font_Style, 'Arial Black' ); ?>><?php esc_html_e( 'Arial Black', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Courier New');?>" <?php selected($Author_PGPP_Font_Style, 'Courier New' ); ?>><?php esc_html_e( 'Courier New', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('cursive');?>" <?php selected($Author_PGPP_Font_Style, 'cursive' ); ?>><?php esc_html_e( 'Cursive', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('fantasy');?>" <?php selected($Author_PGPP_Font_Style, 'fantasy' ); ?>><?php esc_html_e( 'Fantasy', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Georgia');?>" <?php selected($Author_PGPP_Font_Style, 'Georgia' ); ?>><?php esc_html_e( 'Georgia', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Grande');?>"<?php selected($Author_PGPP_Font_Style, 'Grande' ); ?>><?php esc_html_e( 'Grande', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Helvetica Neue');?>" <?php selected($Author_PGPP_Font_Style, 'Helvetica Neue' ); ?>><?php esc_html_e( 'Helvetica Neue', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Impact');?>" <?php selected($Author_PGPP_Font_Style, 'Impact' ); ?>><?php esc_html_e( 'Impact', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Lucida');?>" <?php selected($Author_PGPP_Font_Style, 'Lucida' ); ?>><?php esc_html_e( 'Lucida', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Lucida Console');?>"<?php selected($Author_PGPP_Font_Style, 'Lucida Console' ); ?>><?php esc_html_e( 'Lucida Console', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('monospace');?>" <?php selected($Author_PGPP_Font_Style, 'monospace' ); ?>><?php esc_html_e( 'Monospace', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Open Sans');?>" <?php selected($Author_PGPP_Font_Style, 'Open Sans' ); ?>><?php esc_html_e( 'Open Sans', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Palatino');?>" <?php selected($Author_PGPP_Font_Style, 'Palatino' ); ?>><?php esc_html_e( 'Palatino', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('sans');?>" <?php selected($Author_PGPP_Font_Style, 'sans' ); ?>><?php esc_html_e( 'Sans', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('sans-serif');?>" <?php selected($Author_PGPP_Font_Style, 'sans-serif' ); ?>><?php esc_html_e( 'Sans-Serif', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Tahoma');?>" <?php selected($Author_PGPP_Font_Style, 'Tahoma' ); ?>> <?php esc_html_e( 'Tahoma', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Times New Roman');?>"<?php selected($Author_PGPP_Font_Style, 'Times New Roman' ); ?>><?php esc_html_e( 'Times New Roman', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Trebuchet MS');?>" <?php selected($Author_PGPP_Font_Style, 'Trebuchet MS' ); ?>><?php esc_html_e( 'Trebuchet MS', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
								<option value="<?php echo esc_attr('Verdana');?>" <?php selected($Author_PGPP_Font_Style, 'Verdana' ); ?>><?php esc_html_e( 'Verdana', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
							</optgroup>
