	...
	<ul id="temp_menu">
		<li>
			<label class="lbl_temp arrow-left ">
				<input id="Tem_pl_at_e"name="Tem_pl_at_e" type="radio" value="<?php echo esc_attr('11');?>"  onclick=" dis_play_ed(this.value);"  <?php checked( '11',$Tem_pl_at_e ); ?> style="display:none;" />
		...
		<li>
			<label class="lbl_temp">
				<input id="Tem_pl_at_e" name="Tem_pl_at_e" type="radio" value="<?php echo esc_attr('12');?>" onclick="dis_play_ed(this.value);"   <?php checked( '12',$Tem_pl_at_e ); ?> style="display:none;"/>
