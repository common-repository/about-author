...
<table class="form-table aap_layout_setting"  >
		...
		<th colspan="2">
			<label>
				...
				if ( ! isset( $bodr ) ) {
					$bodr = '1'; }
				?>
				<input id="bodr" name="bodr" type="radio" value="<?php echo esc_attr('1');?>"  <?php checked( '1', $bodr ); ?> style="display:none;"/>
				<img src="<?php echo WEBLIZAR_ABOUT_ME_PLUGIN_URL . 'settings/images/pic2.png'; ?>"  />
			</label>
			<label>
				<input id="bodr" name="bodr" type="radio" value="<?php echo esc_attr('3');?>" <?php checked( '3', $bodr ); ?> style="display:none;"/>
	...
	<tr>
		...
		<td> <?php
		if ( ! isset( $img_bdr_type ) ) {
			$img_bdr_type = 'solid'; }
		?>
			<select name="img_bdr_type" id="img_bdr_type">
				<?php
				 $options_bdr_type = array( 'none', 'solid' );
	...
	<tr>
		...
		<td>
			<input type="range" class="slider" min="1" max="10" step="1" value="<?php
			if ( ! isset( $bdr_size ) ) {
	...
	<tr>
		...
		<td>
			<p>
				<input class="my-color-picker" id="img_bdr_color" name="img_bdr_color" type="text"  value="<?php
				if ( ! isset( $img_bdr_color ) ) {
	...
	<tr class="co_lo_hi_d" style=" <?php echo esc_attr( $d_n_t ); ?>" >
		...
		<td>
			<p>
				<input  type="text" class="my-color-picker" id="About_me_bg_color" name="About_me_bg_color" value="<?php
				if ( ! isset( $About_me_bg_color ) ) {
					echo esc_attr( $About_me_bg_color = '#dd3333' );
				} else {
					echo esc_attr( $About_me_bg_color ); }
				?>"/>
			<p>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input class="widefat"  id="About_me_user_name" name="About_me_user_name" type="text" value="<?php
			if ( ! isset( $About_me_user_name ) ) {
				echo esc_attr( $About_me_user_name = 'About_me_web_site_name ' );
			} else {
				echo esc_attr( $About_me_user_name ); }
			?>"/>
		</td>
	</tr>
	<tr>
		...
		<td>
			<input class="slider" type="range" min="12" max="40" step="1" value="<?php
			if ( ! isset( $name_font_size ) ) {
				echo esc_attr( $name_font_size = '20' );
			} else {
				echo esc_attr( $name_font_size ); }
			?>"data-orientation="vertical" id="name_font_size"name="name_font_size"  oninput="outputUpdate(value);" /> <span id="name_set_span_value" name="name_set_span_value" class="volum" ><?php esc_html_e( $name_font_size ); ?><span>
		</td>
	</tr>
	<tr>
		...
		<td>
			<p>
				<input class="my-color-picker" id="name_Color" name="name_Color" type="text"  value="<?php
				if ( ! isset( $name_Color ) ) {
	...
	<tr>
		...
		<td><input class="widefat" id="About_me_web_site_name"  name="About_me_web_site_name" type="text" value="<?php
		if ( ! isset( $About_me_web_site_name ) ) {
			echo esc_attr( $About_me_web_site_name = 'About_me_web_site_name' );
		} else {
			echo esc_attr( $About_me_web_site_name ); }
		?>"/>
	</td>
	</tr>
	<tr>
		...
		<td>
			<input class="widefat" id="About_me_web_site_url"  name="About_me_web_site_url" type="text" value="<?php
			if ( ! isset( $About_me_web_site_url ) ) {
				echo esc_attr( $About_me_web_site_url = 'http://www.About_me_web_site_name .com' );
			} else {
				echo esc_attr( $About_me_web_site_url ); }
			?>"/>
		</td>
	</tr>
	<tr>
		<th><label><?php esc_html_e( 'Font size', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></label></th>
		<td><input type="range" class="slider" min="12" max="40" step="1" value="<?php
		if ( ! isset( $weblink_font_size ) ) {
			echo esc_attr( $weblink_font_size = '20' );
		} else {
			echo esc_attr( $weblink_font_size ); }
		?>"data-orientation="vertical" id="weblink_font_size" name="weblink_font_size"   oninput="outputUpdate2(value);"> <span id="weblink_set_span_value"name="weblink_set_span_value"class="volum2" ><?php esc_html_e( $weblink_font_size ); ?><span>
		</td>
	</tr>
	<tr>
		<th><label><?php esc_html_e( 'Website Link Color', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></label></th>
		<td><input class="my-color-picker" id="weblink_text_color" name="weblink_text_color" type="text"  value="<?php
		if ( ! isset( $weblink_text_color ) ) {
	...
	<tr>
		...
		<td>
			<textarea class="widefat" id="About_me_dis_cription" name="About_me_dis_cription" maxlength="325" style="height:160px;"><?php
			if ( ! isset( $About_me_dis_cription ) ) {
				echo htmlentities( $About_me_dis_cription = 'About_me_web_site_name  Creators of Premium WordPress Minimalist WordPress Themes For Creatives' );
			} else {
				echo htmlentities( $About_me_dis_cription );}
			?></textarea>
	...
	<tr>
		<th><label><?php esc_html_e( 'Font size', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></label></th>
		<td><input class="slider" type="range" min="12" max="40" step="1" value="<?php
		if ( ! isset( $dis_font_size ) ) {
			echo esc_attr( $dis_font_size = '20' );
		} else {
			echo esc_attr( $dis_font_size ); }
		?>"data-orientation="vertical" id="dis_font_size" name="dis_font_size" oninput="outputUpdate3(value);"> <span id="dis_set_span_value" name="dis_set_span_value" class="volum3" ><?php esc_html_e( $dis_font_size ); ?><span>
		</td>
	</tr>
	<tr>
		<th><label><?php esc_html_e( 'Description Text Color', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></label></th>
		<td><input class="my-color-picker" id="dis_text_color" name="dis_text_color" type="text"  value="<?php
		if ( ! isset( $dis_text_color ) ) {
	...
	<tr>
		...
		<td><input class="widefat" id="followfb" name="followfb" type="text" value="<?php
		if ( ! isset( $followfb ) ) {
			echo esc_url( $followfb = 'https://www.facebook.com/Weblizar-1440510482872657/' );
		} else {
			echo esc_url( $followfb ); }
		?>"/>
		</td>
	</tr>
	<tr>
		...
		<td><input class="widefat" id="followtwit" name="followtwit" type="text"  value="<?php
		if ( ! isset( $followtwit ) ) {
			echo esc_url( $followtwit = 'https://twitter.com/weblizar' );
		} else {
			echo esc_url( $followtwit ); }
		?>"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td><input class="widefat" id="followlinkdln" name="followlinkdln" type="text"  value="<?php
		if ( ! isset( $followlinkdln ) ) {
			echo esc_url( $followlinkdln = 'https://in.linkedin.com/in/weblizar' );    } else {
			echo esc_url( $followlinkdln ); }
			?>"/>
		</td>
	</tr>
	<tr>
		...
		<td><input class="widefat" id="followpint" name="followpint" type="text"  value="<?php
		if ( ! isset( $followpint ) ) {
			echo esc_url( $followpint = 'https://in.pinterest.com' );  } else {
			echo esc_url( $followpint ); }
			?>"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td><input class="widefat" id="followinsta" name="followinsta" type="text" value="<?php
		if ( ! isset( $followinsta ) ) {
			echo esc_url( $followinsta = 'https://www.instagram.com/?hl=en' );
		} else {
			echo esc_url( $followinsta ); }
		?>"/>
	</td>
	</tr>
	...
	<tr>
		...
		<td>
			<p>
				<input  type="text" class="my-color-picker" id="About_me_social_color" name="About_me_social_color" value="<?php
				if ( ! isset( $About_me_social_color ) ) {
					echo esc_attr( $About_me_social_color = '#ffffff' );
				} else {
					echo esc_attr( $About_me_social_color ); }
				?>"/>
			</p>
		</td>
	</tr>
	...
	<tr>
		...
		<td><input class="slider" type="range" min="15" max="40" step="1" value="<?php
		if ( ! isset( $Social_icon_size ) ) {
			echo esc_attr( $Social_icon_size = '20' );
		} else {
			echo esc_attr( $Social_icon_size ); }
		?>"data-orientation="vertical" id="Social_icon_size"name="Social_icon_size"  oninput="Social_icon_size_outputUpdate(value);" /> <span id="Social_icon_set_span_value" name="Social_icon_set_span_value" class="volum5" ><?php esc_html_e( $Social_icon_size ); ?><span>
		</td>
	</tr>
	<tr>
		<td colspan="2">
	...
	<tr>
		...
		<td>	
		<?php
		if ( ! isset( $PGPP_Font_Style ) ) {
			$PGPP_Font_Style = 'Courier New'; }
		?>
			<select  name="PGPP_Font_Style" id="PGPP_Font_Style" class="standard-dropdown" >
				<optgroup label="Default Fonts">
					<option value="<?php echo esc_attr('Arial');?>" <?php selected( $PGPP_Font_Style, 'Arial' ); ?>> <?php esc_html_e( 'Arial', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Arial Black');?>" <?php selected( $PGPP_Font_Style, 'Arial Black' ); ?>> <?php esc_html_e( 'Arial Black', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Courier New');?>" <?php selected( $PGPP_Font_Style, 'Courier New' ); ?>><?php esc_html_e( 'Courier New ', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('cursive');?>" <?php selected( $PGPP_Font_Style, 'cursive' ); ?>> <?php esc_html_e( 'Cursive', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('fantasy');?>" <?php selected( $PGPP_Font_Style, 'fantasy' ); ?>> <?php esc_html_e( 'Fantasy', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Georgia');?>" <?php selected( $PGPP_Font_Style, 'Georgia' ); ?>> <?php esc_html_e( 'Georgia', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Grande');?>"<?php selected( $PGPP_Font_Style, 'Grande' ); ?>> <?php esc_html_e( 'Grande', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Helvetica Neue');?>" <?php selected( $PGPP_Font_Style, 'Helvetica Neue' ); ?>> <?php esc_html_e( 'Helvetica Neue', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Impact');?>" <?php selected( $PGPP_Font_Style, 'Impact' ); ?>> <?php esc_html_e( 'Impact', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Lucida');?>" <?php selected( $PGPP_Font_Style, 'Lucida' ); ?>> <?php esc_html_e( 'Lucida', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Lucida Console');?>"<?php selected( $PGPP_Font_Style, 'Lucida Console' ); ?>> <?php esc_html_e( 'Lucida Console', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('monospace');?>" <?php selected( $PGPP_Font_Style, 'monospace' ); ?>> <?php esc_html_e( 'Monospace', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Open Sans');?>" <?php selected( $PGPP_Font_Style, 'Open Sans' ); ?>> <?php esc_html_e( 'Open Sans', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Palatino');?>" <?php selected( $PGPP_Font_Style, 'Palatino' ); ?>> <?php esc_html_e( 'Palatino', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('sans');?>" <?php selected( $PGPP_Font_Style, 'sans' ); ?>><?php esc_html_e( 'Sans', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('sans-serif');?>" <?php selected( $PGPP_Font_Style, 'sans-serif' ); ?>><?php esc_html_e( 'Sans-Serif', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Tahoma');?>" <?php selected( $PGPP_Font_Style, 'Tahoma' ); ?>> <?php esc_html_e( 'Tahoma', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Times New Roman');?>"<?php selected( $PGPP_Font_Style, 'Times New Roman' ); ?>> <?php esc_html_e( 'Times New Roman', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Trebuchet MS');?>" <?php selected( $PGPP_Font_Style, 'Trebuchet MS' ); ?>> <?php esc_html_e( 'Trebuchet MS', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
					<option value="<?php echo esc_attr('Verdana');?>" <?php selected( $PGPP_Font_Style, 'Verdana' ); ?>> <?php esc_html_e( 'Verdana', 'WEBLIZAR_ABOUT_DOMAIN' ); ?></option>
				</optgroup>
								...
								if ( is_array( $fonts_list ) ) {
									if ( isset( $fonts_list['items'] ) ) {
										...
										foreach ( $g_fonts as $g_font ) {
											...
											?>
												<option value="<?php echo esc_attr( $font_name ); ?>" <?php selected( $PGPP_Font_Style, $font_name ); ?>><?php esc_html_e( $font_name ); ?></option>
											   <?php
										}
									}
								} else {
	...
	<tr>
		...
		<td>
			<textarea class="widefat" id="About_me_custom_css" name="About_me_custom_css"><?php
			if ( ! isset( $About_me_custom_css ) ) {
				echo esc_textarea( $About_me_custom_css = '' );
			} else {
				echo esc_textarea( $About_me_custom_css );}
			?></textarea>
			<p class="description">
